...
function renderManzokukyoGallery(character) {
  ...
  const seals = new Map([
    ...
    [5, { order: 5, fragment: "び" }],
    [9, { order: 1, fragment: "あ" }],
    [14, { order: 2, fragment: "か" }],
    [17, { order: 6, fragment: "ら" }],
    [21, { order: 4, fragment: "と" }]
  ]);
  ...
  return htmlPage({
    ...
    body: `
      ...
      <main class="gallery-page">
        ...
        <section class="gallery-puzzle" aria-labelledby="gallery-puzzle-title"><div><span class="gallery-eyebrow">Sealed records / observation required</span><h2 id="gallery-puzzle-title">展示に残った六つの検印</h2><p>金色の検印が付いた記録を開き、照合していく。集まった文字を番号順に並べれば、次の扉を呼ぶ言葉になる。</p><div class="gallery-seal-slots" aria-label="集めた検印"><span class="gallery-seal-slot" data-seal-slot="1">—</span><span class="gallery-seal-slot" data-seal-slot="2">—</span><span class="gallery-seal-slot" data-seal-slot="3">—</span><span class="gallery-seal-slot" data-seal-slot="4">—</span><span class="gallery-seal-slot" data-seal-slot="5">—</span><span class="gallery-seal-slot" data-seal-slot="6">—</span></div></div><form class="gallery-puzzle-form" data-gallery-puzzle><label for="gallery-answer">六つの文字を、続けて入力</label><input id="gallery-answer" name="answer" autocomplete="off" placeholder="ひらがなで入力" disabled><button type="submit" disabled>扉を呼ぶ</button><p class="gallery-puzzle-message" data-gallery-message>検印を探してください。0 / 6</p></form></section>
