...
export async function buildManzokukyoPreview() {
  ...
  const galleryFiles = await Promise.all(['manzokukyo-gallery-opening.js', 'manzokukyo-gallery-opening.css', 'manzokukyo-gallery-sand.js', 'manzokukyo-gallery-world.js', 'manzokukyo-gallery-decor.js', 'manzokukyo-gallery.js', 'manzokukyo-gallery.css', 'manzokukyo-gallery-3d.js', 'manzokukyo-gallery-3d.css', 'manzokukyo-gallery-walk.js', 'manzokukyo-gallery-loop.js', 'manzokukyo-gallery-hand.js', 'manzokukyo-gallery-visitor.js'].map(name => readFile(path.join(characterRoot, 'assets/site', name), 'utf8')));
