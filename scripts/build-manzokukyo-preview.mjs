...
export async function buildManzokukyoPreview() {
  ...
  const galleryFiles = await Promise.all(['manzokukyo-gallery.js', 'manzokukyo-gallery.css', 'manzokukyo-gallery-3d.js', 'manzokukyo-gallery-3d.css', 'manzokukyo-gallery-walk.js', 'manzokukyo-gallery-loop.js'].map(name => readFile(path.join(characterRoot, 'assets/site', name), 'utf8')));
