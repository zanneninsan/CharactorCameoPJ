const EFFECT_NAMES = ['gallery-world-wind', 'tap', 'step-1', 'step-2', 'discover', 'projector', 'transmission', 'portrait', 'door-open', 'enter', 'offering-empty', 'offering-coin', 'offering-note', 'offering-blessing', 'offering-royal', 'truth-denied', 'gallery-reveal', 'gallery-collect', 'gallery-complete', 'gallery-unseal', 'gallery-door'];
